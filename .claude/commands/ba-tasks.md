...
## Rules
- Read `documents/planning/modules.md` to find all stories for the given module
- Read `documents/planning/architecture.md` and `documents/planning/coding-standards.md` for technical context
...
Example: `documents/modules/M1-project-setup/tasks/T001-init-fe-source/task.md`
...
## References
- Architecture: [relevant section in documents/planning/architecture.md]
- Standards: [relevant section in documents/planning/coding-standards.md]
...
2. Read `documents/planning/modules.md` — find the module section and all its stories
