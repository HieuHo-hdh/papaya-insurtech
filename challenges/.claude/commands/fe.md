...
- Every form must implement validation rules from `planning/architecture.md`
...
- Follow folder structure in `planning/coding-standards.md` strictly
...
## Component Rules (see planning/coding-standards.md)
| Instead of | Use |
|-----------|-----|
